...
Partial Class NavieraListado
    ...
    Protected Sub GridView1_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles GridView1.RowCommand
        Try
            ...
            Select Case e.CommandName
                Case "EDIT"
                    Response.Redirect("NavieraGestion.aspx?ID=" & id & "&accion=EDIT")
                Case "DELETE"
                    Response.Redirect("NavieraGestion.aspx?ID=" & id & "&accion=DELETE")
                Case "VER"
                    Response.Redirect("..\verNaviera.aspx?ID=" & id, True)
            End Select
    ...
    Private Sub ReBind()
        ...
        If sortExpression = String.Empty Then
            lastDirection = "ID"
        End If
        Dim list As List(Of Naviera) = Naviera.Lista(filtro, sortExpression & " " & lastDirection)
