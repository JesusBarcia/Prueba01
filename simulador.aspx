<%@ Page Language="VB" AutoEventWireup="false" CodeFile="simulador.aspx.vb" Inherits="Simulador" %>
...
<body>
  ...
  <div class="container">
<div class="content">
  <h3><a href="http://www.shortsea.es">SHORTSEA.ES</a> SIMULADOR DE CADENAS DE TRANSPORTE |TRANSPORT CHAINS SIMULATOR</h3>
             ...
             <asp:Panel ID="PanelParametros" runat="server" Width="650px">
                  ...
                  <tr style="height:10px; vertical-align:top"><!-- Fila 2 -->
                    <td align="left" style="width:100px"><!-- Celda 1 -->
                        <asp:Label ID="lblOrigen" runat="server" Text="Origen/From:" CssClass="txtsmallazul11" ></asp:Label>
                    </td>
                  ...
                  <tr style="height:10px; vertical-align:top"><!-- Fila 4 -->
                    <td align="left" style="width:100px"><!-- Celda 1 -->
                        <asp:Label ID="lblDestino" runat="server" CssClass="txtsmallazul11" Text="Destino/To: " />
                    </td>
                    <td align="left" style="width:140px"><!-- Celda 2 -->
                  ...
                  <asp:Label ID="lblToneladas" runat="server" CssClass="txtsmallazul11" Text="Toneladas netas de carga/Net tons of cargo: " />
...
-->                  
                  ...
                  <br />
                  &nbsp;&nbsp;
                  <asp:Label ID="Label4" runat="server" CssClass="txtsmallazul11" Text="Euros/Km: " Width="100px"></asp:Label>
                  <asp:TextBox ID="txtCosteKm" runat="server" CssClass="txtverdanasmallderecha" text-align="right" Width="59px"></asp:TextBox>
                  &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp;
                  <asp:Label ID="Label5" runat="server" CssClass="txtsmallazul11" Text="Vel. Media Km/h /Average speed: "></asp:Label>
            <asp:TextBox ID="txtVelocidad" runat="server" CssClass="txtverdanasmallderecha" Width="59px"></asp:TextBox>
            <br />
                  &nbsp;&nbsp;
            <asp:Label ID="Label12" runat="server" Text="Peajes/Tools €: " CssClass="txtsmallazul11"  Width="100px"></asp:Label>
...
-->
            ...
            <br />
            &nbsp;&nbsp;
            <asp:Label ID="Label15" runat="server" Text="Euros/Km Acarreo Origen/Origin hauling"  Width="230px" CssClass="txtsmallazul11"></asp:Label>
            <asp:TextBox  text-align="right" ID="txtCosteKmAcarreoOrigen" runat="server" CssClass="txtverdanasmallderecha" Width="59px"></asp:TextBox>
                  &nbsp; &nbsp;
            <asp:Label ID="Label20" runat="server" Text="Vel. Km/h Acarreo Origen/Origin hauling: "   Width="230px" CssClass="txtsmallazul11"></asp:Label>
            <asp:TextBox ID="txtVelocidadAcarreoOrigen" runat="server" CssClass="txtverdanasmallderecha" Width="59px"></asp:TextBox>
            <br />
            &nbsp;&nbsp;
            <asp:Label ID="Label16" runat="server" Text="Euros/Km Acarreo Destino/Destination hauling:" Width="230px" CssClass="txtsmallazul11" />
            <asp:TextBox text-align="right" ID="txtCosteKmAcarreoDestino" runat="server" CssClass="txtverdanasmallderecha" Width="59px"></asp:TextBox>
                  &nbsp; &nbsp;
            <asp:Label ID="Label21" runat="server" Text="Vel. Km/h Acarreo Destino/Destination hauling: "   Width="230px" CssClass="txtsmallazul11"></asp:Label>
...
-->
            ...
            <br /> 
                  &nbsp;&nbsp;
            <asp:Label ID="Label9" runat="server" Text="Mercancías Peligrosas/Dangerous Goods" CssClass="txtsmallazul11" Width="220px"></asp:Label>
            <asp:CheckBox  ID="txtRecargoMercanciaPeligrosa" runat="server" CssClass="blue" />
                  &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Label ID="Label1" runat="server" Text="¿Acompañado?/Accompanied?" CssClass="txtsmallazul11" Width="160px"></asp:Label>
            <asp:CheckBox ID="txtRecargoCabezaTractora" runat="server" CssClass="blue" />
            <br />
                  &nbsp;&nbsp;
            <asp:Label ID="Label8" runat="server" Text="Carga refrigerada/Refrigerated cargo" CssClass="txtsmallazul11" Width="220px"></asp:Label>
            <asp:CheckBox ID="txtRecargoRefrigerado" runat="server" CssClass="blue" />
                  &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;

            <asp:Label ID="Label7" runat="server" Text="Animales Vivos/Live animals" CssClass="txtsmallazul11" Width="160px"></asp:Label>
            ...
            <br />
            &nbsp;&nbsp;
            <asp:ListBox ID="txtListBoxLineas" runat="server" CssClass="txtverdanasmall" Height="120px" Rows="12" SelectionMode="Multiple"  margin-top="10px" Width="455px" BackColor="#E8F0F5" ></asp:ListBox>
            <br />
            <br />
            &nbsp;&nbsp;
            <asp:Label ID="Label2" runat="server" Text="Alta Frecuencia/High Frequency" CssClass="txtsmallazul11" Width="220px"></asp:Label>
            <asp:CheckBox  ID="txtAltaFrecuencia" runat="server" CssClass="blue" />
                  &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Label ID="Label6" runat="server" Text="Fachada Cantábrica/Cantabrian Seaboard" CssClass="txtsmallazul11" Width="250px"></asp:Label>
            <asp:CheckBox ID="txtFachadaCantabrica" runat="server" Checked="false" CssClass="blue" />
            <br />
            &nbsp;&nbsp;
            <asp:Label ID="Label18" runat="server" Text="Fachada Atlántica/Atlantic Seaboard" CssClass="txtsmallazul11" Width="220px"></asp:Label>
            <asp:CheckBox  ID="txtFachadaAtlantica" runat="server"  Checked="false" CssClass="blue" />
                  &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Label ID="Label19" runat="server" Text="Fachada Mediterránea/Mediterranean Seaboard" CssClass="txtsmallazul11" Width="250px"></asp:Label>
            <asp:CheckBox ID="txtFachadaMediterranea" runat="server" Checked="false" CssClass="blue" />
            <br />
            <br />
                  &nbsp;&nbsp;
            <asp:Label ID="Label3" runat="server" CssClass="txtsmallazul11" Text="Resultados ordenados por/Results ordered by:" />
                  &nbsp; 
            <asp:RadioButton ID="RBCoste" GroupName="optimizado" runat="server" CssClass="txtsmallazul11" Text="Coste/Cost" Checked="True" />
                  &nbsp;&nbsp;
            <asp:RadioButton ID="RBTiempo" GroupName="optimizado" runat="server" CssClass="txtsmallazul11" Text="Tiempo/Time" />
                  &nbsp; &nbsp;
            <asp:RadioButton ID="rbDistancia"  GroupName="optimizado" runat="server" CssClass="txtsmallazul11"  Text="Distancia/Distance"/>
        ...
        <asp:Panel ID="PanelBotones"   runat="server" Height="60px" Width="650px" BorderColor="Beige">
                  ...
                  <asp:Button ID="btnCalcular" runat="server" CssClass="blue" Text="Calcular/Calculate"  Width="220px" OnClientClick="javascript:comprobarAddress()" />
                  &nbsp; &nbsp;
                  <asp:Button ID="btnCalcularMapa" runat="server" CssClass="blue" Text="Ver Mapa Resultados/View Results Map "  Width="220px" />
                  <br />
                  <asp:Button ID="btnNuevaSimulacion" runat="server" CssClass="blue" Text="Nueva Simulación/New Simulation" Width="220px" />
                  &nbsp; &nbsp;                  
             ...
             <asp:DataList  ID="DataList1"   OnItemCommand="seleccionar" runat="server" Visible="False" CellPadding="0" Width="575px" >
                    ...
                    <ItemTemplate>
                        ...
                        <SelectedItemTemplate>
                            ...
                            <td width="80px" align="right" class="txtverdanasmallderecha"><%# CType(Container.DataItem("costeOrigenPuerto"), Single).ToString("N0")%></td>
                            <td width="80px" align="right" class="txtverdanasmallderecha"><%# CType(Container.DataItem("tiempoOrigenPuerto"), Single).ToString("F1")%></td>
                            <td width="80px" align="right" class="txtverdanasmallderecha"><%# CType(Container.DataItem("distanciaOrigenPuerto"), Single).ToString("N0")%></td>
                            <td width="80px" align="right" class="txtverdanasmallderechaverde"><%# CType(Container.DataItem("costesExternosOrigenPuerto"), Single).ToString("N0")%></td>
                            <td width="80px" align="right" class="txtverdanasmallderechaverde"><%# CType(Container.DataItem("costeEmisionCO2OrigenPuerto"), Single).ToString("N0")%></td>
                           </tr> 
                            <tr style="background-color:#FFFFC0">
                            <td width="35px" align="center"></td>
                            ...
                            <td width="80px" align="right" class="txtverdanasmallderecha"><b><%# CType(Container.DataItem("costePuertoPuertoconRecargos"), Single).ToString("N0")%></b></td>
                            <td width="80px" align="right" class="txtverdanasmallderecha"><b><%# CType(Container.DataItem("tiempoPuertoPuerto"), Single).ToString("F1")%></b></td>
                            <td width="80px" align="right" class="txtverdanasmallderecha"><b><%# CType(Container.DataItem("distanciaPuertoPuerto"), Single).ToString("N0")%></b></td>
                            <td width="80px" align="right" class="txtverdanasmallderechaverde"><b><%# CType(Container.DataItem("costesExternosPuertoPuerto"), Single).ToString("N0")%></b></td>
                            <td width="80px" align="right" class="txtverdanasmallderechaverde"><b><%# CType(Container.DataItem("costeEmisionCO2PuertoPuerto"), Single).ToString("N0")%></b></td>
                           ...
                           <td width="35px" align="center"></td>
                            ...
                            <td width="80px" align="right" class="txtverdanasmallderecha"><%# CType(Container.DataItem("costePuertoDestino"), Single).ToString("N0")%></td>
                            <td width="80px" align="right" class="txtverdanasmallderecha"><%# CType(Container.DataItem("tiempoPuertoDestino"), Single).ToString("F1")%></td>
                            <td width="80px" align="right" class="txtverdanasmallderecha"><%#CType(Container.DataItem("distanciaPuertoDestino"), Single).ToString("N0")%></td>
                            <td width="80px" align="right" class="txtverdanasmallderechaverde"><%# CType(Container.DataItem("costesExternosPuertoDestino"), Single).ToString("N0")%></td>
                            <td width="80px" align="right" class="txtverdanasmallderechaverde"><%# CType(Container.DataItem("costeEmisionCO2PuertoDestino"), Single).ToString("N0")%></td>
                           </tr> 
                           <tr style="background-color:White">
                            <td width="35px" align="center"></td>
