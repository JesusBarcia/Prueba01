...
Partial Class Simulador
    ...
    Const C_PanelSimulador As Long = 1650
    Const C_PanelParametrosHeight As Long = 770
    Const C_PanelBotonesHeight As Long = 60
    Const C_PanelResumenHeight As Long = 90
    Const C_PanelResultadosHeight As Long = 480
    Const C_PanelLogoFomentoHeight As Long = 160
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Me.IsPostBack Then
            Try
                ...
                Me.txtListBoxLineas.Items.Add(New ListItem("TODAS/ALL LINES", "TODAS"))
                Me.txtListBoxLineas.Items.Add(New ListItem("RECOMENDADAS/RECOMMENDED", "RECOMENDADAS"))
    ...
    Private Sub PintarResultadosTotales()
        Try
            ...
            Me.LabelTituloTotales_EN.Visible = True
            Me.LabelTituloTotales.Text = "Transporte Intermodal con líneas marítimas existentes."
            Me.LabelTituloTotales_EN.Text = "Existing maritime intermodal transport lines."
    ...
    Private Sub Encabezado(ByVal t As Table)
        Dim r As New TableRow
        Dim celda(5) As TableCell
        celda(0) = New TableCell : celda(0).Text = "Origen-Destino/From-To" : celda(0).CssClass = "titularazul"
        celda(1) = New TableCell : celda(1).Text = "Coste/Cost (Eur)" : celda(1).CssClass = "titularazulderecha"
        celda(2) = New TableCell : celda(2).Text = "Tiempo/Transit-Time (Hor)" : celda(2).CssClass = "titularazulderecha"
        celda(3) = New TableCell : celda(3).Text = "Distancia/Distance (Km)" : celda(3).CssClass = "titularazulderecha"
        celda(4) = New TableCell : celda(4).Text = "Cost.Ext/Ext.Cost (Eur)" : celda(4).CssClass = "titularverdederecha"
        celda(5) = New TableCell : celda(5).Text = "Emis CO2/CO2 Emiss. (Kg)" : celda(5).CssClass = "titularverdederecha"
        r.Cells.AddRange(celda)
        t.Rows.Add(r)
    End Sub
